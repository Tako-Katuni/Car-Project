...
public class Tesla  extends Car implements NoRequirement{
    ...
    public Tesla(double prices, String brands, String colors, String models){
        this.prices= prices;
        this.brands= brands;
        this.colors= colors;
        this.models= models;
    ...
    public String autoPilot() {
        return "This car has an autopilot";
    }
